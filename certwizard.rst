...
`Windows Installer <https://github.com/stfc/CertWizard/releases/download/v2.0.1/CertWizard_2.0.1.exe>`_

`Mac App <https://github.com/stfc/CertWizard/releases/download/v2.0.1/CertWizard-2.0.1-mac.zip>`_

`Windows Portable App <https://github.com/stfc/CertWizard/releases/download/v2.0.1/CertWizard-2.0.1-windows.zip>`_

`JAR file (for Linux or experienced users, Java 11 required) <https://github.com/stfc/CertWizard/releases/download/v2.0.1/CertWizard.jar>`_
